...
namespace _12labbib.LibraryDbDataSetTableAdapters {
...
SELECT Id, Title, Year, Author, UserId FROM Books WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT Id, Title, Year, Author, UserId FROM dbo.Books\r\nwhere UserId = @ID";
        ...
        public virtual int FillBy(LibraryDbDataSet.BooksDataTable dataTable, int ID) {
